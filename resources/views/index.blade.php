...
<!-- Mirrored from world5.commonsupport.com/html/greenture-new/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 22:01:56 GMT -->
<head>
<meta charset="utf-8">


<title>Kioscoverde | Inicio</title>
...
<div class="page-wrapper">
    	...
    	<div class="header-upper">
        	<div class="auto-container clearfix">
                ...
                <div class="nav-outer clearfix">
                    ...
                    <a href="signup.html" class="theme-btn btn-donate" data-toggle="modal" data-target="#donate-popup">REGISTRATE</a>
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation">
                                ...
                                <li class="dropdown"><a href="#">NOTICIAS</a>
                                    <ul>
                                        <li><a href="intermediaty.html">INTERMEDIACIONES</a> </li>
                                        <li><a href="agend.html">AGENDA</a></li>
                                        <li><a href="noty.html">NOTICIAS AMBIENTALES</a></li>
                                        <li><a href="investigation.html">INVESTIGACIÓN</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">SERVICIOS</a>
                                    <ul>
                                        <li><a href="reciclemanage.html">GESTION DE RESIDUOS</a></li>
                                 ...
                                 <li class="dropdown"><a href="#">CONTACTANOS</a>
                                    <ul>
                                        ...
                                        <li><a href="contactus.html">ESCRÍBENOS</a></li>
                                        <li class="dropdown">
                                            <a href="team-single.html">BIBLIOTECA</a>
                                            <ul>
                                                <li><a href="documents.html">MARCO NORMATIVO</a></li>
                                                <li><a href="documentsother.html">OTROS DOCUMENTOSs</a></li>
                                            </ul>
    	...
    	<div class="outer clearfix">
            ...
            <article class="column text-column dark-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms" style="background-image:url(images/resource/fluid-image-2.jpg);">
                ...
                <div class="content-box pull-left">
                    ...
                    <a href="#" class="theme-btn btn-style-one">APLICAR</a>
                    <a href="#" class="theme-btn btn-style-two">MAS DETALLES</a>
                </div>
    	...
    	<div class="auto-container">
            ...
            <div class="sec-title clearfix">
                ...
                <div class="pull-right padd-top-30">
                	<a href="#" class="theme-btn btn-style-three">Ver todos los PROYECTOS</a>
                </div>
            </div>
        	<div class="row clearfix">
                ...
                <div class="column default-featured-column col-md-3 col-sm-6 col-xs-12">
                	<article class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        ...
                        <div class="content-box">
                        	<h3><a href="#">Nombre de proyecto</a></h3>
                            <div class="column-info">Informacion</div>
                            <div class="text">Descripcion</div>
                	...
                	<article class="inner-box">
                		<div class="vertical-links-outer">
                        	<div class="link-block">
                            	<div class="default inner"><figure class="image-thumb"><img src="images/resource/post-thumb-1.jpg" alt=""></figure><strong>Certificacion Verde</strong><span class="desc">Certificate como empresa VERDE </span></div>
                                <a href="#" class="alternate"><strong>Certificate como empresa VERDE</strong><span class="desc">Certificate como empresa VERDE </span></a>
                            </div>

                            <div class="link-block">
                            	<div class="default inner"><figure class="image-thumb"><img src="images/resource/post-thumb-1.jpg" alt=""></figure><strong>Servicio 2</strong><span class="desc">Descripcion 2 </span></div>
                               <a href="#" class="alternate"><strong>Servicio 2</strong><span class="desc">Descripcion </span></a>
                            </div>
    ...
    <section class="testimonials-section" style="background-image:url(images/background/testimonials-bg.jpg);">
		<div class="auto-container">
            ...
            <div class="sec-title text-center">
                <h2>Testi<span class="normal-font theme_color">Monios</span></h2>
                <div class="text">Algunos comentarios: </div>
            </div>
        	...
        	<div class="testimonials-slider testimonials-carousel">
                ...
                <article class="slide-item">
                    ...
                    <div class="info-box">
                    	...
                    	<h3>Persona N</h3>
                        <p class="designation">Designacion</p>
                    </div>
        	...
        	<div class="row clearfix">
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                		<figure class="image-box">
                        	<a href="#"><img src="https://concepto.de/wp-content/uploads/2020/11/importancia-de-reciclar-e1604431187998.jpg" alt=""></a>
                            <div class="news-date">dia <span class="month">mes</span></div>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">La importancia de reciclar</a></h3>
                        	<div class="post-info clearfix">
                            	<div class="post-author">Autor que posteo</div>
                            ...
                            <a href="#" class="theme-btn read-more">Saber mas</a>
                        </div>
                    </article>
                </div>
        ...
        <div class="auto-container">
            <div class="slider-outer">
                ...
                <ul class="sponsors-slider">
                    <li><a href="#"><img src="https://png.pngtree.com/template/20190928/ourlarge/pngtree-chart-logo-design-template-with-dark-grey-color-image_312737.jpg" alt=""></a></li>
                    <li><a href="#"><img src="https://png.pngtree.com/template/20190928/ourlarge/pngtree-chart-logo-design-template-with-dark-grey-color-image_312737.jpg" alt=""></a></li>
                    <li><a href="#"><img src="https://png.pngtree.com/template/20190928/ourlarge/pngtree-chart-logo-design-template-with-dark-grey-color-image_312737.jpg" alt=""></a></li>
                    <li><a href="#"><img src="https://png.pngtree.com/template/20190928/ourlarge/pngtree-chart-logo-design-template-with-dark-grey-color-image_312737.jpg" alt=""></a></li>
                    <li><a href="#"><img src="https://png.pngtree.com/template/20190928/ourlarge/pngtree-chart-logo-design-template-with-dark-grey-color-image_312737.jpg" alt=""></a></li>
    ...
    <footer class="main-footer" style="background-image:url(images/background/footer-bg.jpg);">
                    	...
                    	<div class="row clearfix">
                            <div class="col-lg-8 col-sm-6 col-xs-12 column">
                                <div class="footer-widget about-widget">
                                    <div class="logo"><a href="index-2.html"><img src="file:///C:/Users/serio/Downloads/Telegram%20Desktop/kioscoverde.bo/world5.commonsupport.com/html/greenture-new/images/logo-1.png" class="img-responsive" alt=""></a></div>
                                    <div class="text">
    	...
    	<div class="footer-bottom">
            <div class="container">
                ...
                <!-- Privacy Policy -->
                <div class="col-lg-4 col-sm-7 col-xs-12 column">
                    <div class="copyright text-center">  <a href="terms.html">Terminos y condiciones</a></div>
                </div>
                        ...
                        <div class="form-portlet">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div>
                                        <h5>Una persona natural puede ejercer todos los derechos y obligaciones de una empresa a su nombre. Mientras que una persona jurídica, la empresa asume todos los derechos y obligaciones de la misma.</h5>
                                    </div>
...
<!-- Mirrored from world5.commonsupport.com/html/greenture-new/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 22:04:11 GMT -->
</html>
