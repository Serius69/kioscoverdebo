        	...
        	<div class="row clearfix">
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="column default-featured-column">
                            <article class="inner-box">
                                <figure class="image-box">
                                    <a href="#"><img src="images/resource/featured-image-17.jpg" alt=""></a>
                                </figure>
                    ...
                    <section class="related-posts-section padd-right-20">
                    	<h2>Proyectos <span class="normal-font">Relacionados</span></h2>
                    ...
                    <aside class="sidebar">
                        ...
                        <div class="widget recent-posts wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <article class="post">
                                ...
                                <h4><a href="noticy-single.html">Deforestation is threating by  activites...</a></h4>
