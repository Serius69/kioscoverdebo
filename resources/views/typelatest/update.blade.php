...
<div class="container">
    <div class="row">
        <div class="col-md-9 col-md-center margin-tb">
            ...
            @endif
        <div class="col-md-9 col-md-center margin-tb">
            <form  action="{{ route('typelatests.update',$typelatest->id) }}" method="POST" files="true" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" style="margin: 15px;" name="type" class="form-control" value="{{ $typelatest->type }}" >
                                </div>                                
                            </div>
                        </div>
                    </div>
